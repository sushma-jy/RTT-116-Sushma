...
<section>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Glam&Gloss</a>
...
<%--                        </li>--%>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/Product/searchProduct">Search Products</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/Product/orderProduct">Shopping Cart</a>
                                                </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/Product/product">Create Products</a>
                        </li>
